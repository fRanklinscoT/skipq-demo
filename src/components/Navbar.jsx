...
const Navbar = () => {
  return (
    <nav className="w-full sm:w-4/5 md:w-3/4 lg:w-1/2 mx-auto bg-stone-200/80 shadow-md px-4 sm:px-6 py-4 flex justify-between items-center rounded-none sm:rounded-xl sticky shadow-black dark:bg-gray-700 dark:border-gray-600">
